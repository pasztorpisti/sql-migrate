...
func (mr *MockDriverMockRecorder) Open(dsn interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Open", reflect.TypeOf((*MockDriver)(nil).Open), dsn)
}

// CreateMigrationsTable mocks base method
func (m *MockDriver) CreateMigrationsTable(arg0 Execer) error {
	ret := m.ctrl.Call(m, "CreateMigrationsTable", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateMigrationsTable indicates an expected call of CreateMigrationsTable
func (mr *MockDriverMockRecorder) CreateMigrationsTable(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateMigrationsTable", reflect.TypeOf((*MockDriver)(nil).CreateMigrationsTable), arg0)
}

// SetMigrationState mocks base method
func (m *MockDriver) SetMigrationState(e Execer, migrationName string, forwardMigrated bool) error {
	ret := m.ctrl.Call(m, "SetMigrationState", e, migrationName, forwardMigrated)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetMigrationState indicates an expected call of SetMigrationState
func (mr *MockDriverMockRecorder) SetMigrationState(e, migrationName, forwardMigrated interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetMigrationState", reflect.TypeOf((*MockDriver)(nil).SetMigrationState), e, migrationName, forwardMigrated)
}

// GetForwardMigratedNames mocks base method
func (m *MockDriver) GetForwardMigratedNames(arg0 Querier) (map[string]struct{}, error) {
	ret := m.ctrl.Call(m, "GetForwardMigratedNames", arg0)
...
func (mr *MockDriverMockRecorder) GetForwardMigratedNames(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetForwardMigratedNames", reflect.TypeOf((*MockDriver)(nil).GetForwardMigratedNames), arg0)
}
